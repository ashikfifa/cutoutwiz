...
function Footer() {
  return (
    <div class="footer" style={{ backgroundColor: "#231f20" }}>
      <div class="container">
        <div class="row">
          <div class="col-md-3" style={{ marginTop: "4%" }}>
            ...
            <p
              style={{ textAlign: "justify", color: "white", marginTop: "4%" }}
            >
              CutOutWiz is one of the leading image and video editing company
          ...
          <div class="col-6 col-md-3" style={{ marginTop: "5%" }}>
            <b style={{ color: "white", fontSize: "20px" }}>Our Address</b>{" "}
            <br /> <br />
            <iframe
      ...
      >
        Designed And Developed By CutOutWiz
      </p>
    </div>
  );
}
